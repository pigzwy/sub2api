...
func init() {
	...
	// groupDescAllowRealtime is the schema descriptor for allow_realtime field.
	groupDescAllowRealtime := groupFields[48].Descriptor()
	// group.DefaultAllowRealtime holds the default value on creation for the allow_realtime field.
	group.DefaultAllowRealtime = groupDescAllowRealtime.Default.(bool)
