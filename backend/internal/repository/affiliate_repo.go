...
func (r *affiliateRepository) AccrueFirstRechargeQuota(ctx context.Context, inviterID, inviteeUserID int64, amount float64, freezeHours int, sourceRef string, sourceOrderID *int64) (bool, error) {
