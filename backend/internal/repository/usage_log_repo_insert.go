...
var usageLogInsertArgTypes = [...]string{
	...
	"numeric",     // audio_input_cost
	"integer",     // audio_output_tokens
	"numeric",     // audio_output_cost
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			log.AudioInputTokens,  // audio_input_tokens
			log.AudioInputCost,    // audio_input_cost
			log.AudioOutputTokens, // audio_output_tokens
			log.AudioOutputCost,   // audio_output_cost
			createdAt,
		},
	}
}
