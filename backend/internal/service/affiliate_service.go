...
type AffiliateRepository interface {
	...
	AccrueFirstRechargeQuota(ctx context.Context, inviterID, inviteeUserID int64, amount float64, freezeHours int, sourceRef string, sourceOrderID *int64) (bool, error)
...
func (s *AffiliateService) AccrueFirstRechargeRebate(ctx context.Context, inviteeUserID int64, baseRechargeAmount float64, sourceRef string) (float64, error) {
	return s.accrueInviteRebate(ctx, inviteeUserID, baseRechargeAmount, strings.TrimSpace(sourceRef), nil)
}

func (s *AffiliateService) AccrueFirstRechargeRebateForOrder(ctx context.Context, inviteeUserID int64, baseRechargeAmount float64, sourceRef string, sourceOrderID *int64) (float64, error) {
	return s.accrueInviteRebate(ctx, inviteeUserID, baseRechargeAmount, strings.TrimSpace(sourceRef), sourceOrderID)
}

func (s *AffiliateService) accrueInviteRebate(ctx context.Context, inviteeUserID int64, baseRechargeAmount float64, sourceRef string, sourceOrderID *int64) (float64, error) {
	if s == nil || s.repo == nil {
		return 0, nil
	}
	...
	var applied bool
	if sourceRef != "" {
		applied, err = s.repo.AccrueFirstRechargeQuota(ctx, *inviteeSummary.InviterID, inviteeUserID, rebate, freezeHours, sourceRef, sourceOrderID)
	} else {
