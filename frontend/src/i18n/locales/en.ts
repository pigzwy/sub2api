export default {
  ...
  auth: {
    ...
    oauthFlow: {
      ...
      bindCurrentAccountDescription: 'Bind the currently signed-in account to your {providerName} identity.',
      bindCurrentAccountTitle: 'Bind to Current Account',
      bindExistingAccount: 'Bind Existing Account',
      bindLoginHint: 'Sign in to an existing account, then bind it to your {providerName} identity.',
      bindSignInToExistingAccount: 'Sign In and Bind to Existing Account',
      chooseAccountActionHint: 'You can bind an existing account or create a new one.',
      chooseHowToContinue: 'Choose How to Continue',
      createAccountHint: 'A new local account will be created with the profile information below.',
      createNewAccount: 'Create New Account',
      logInAndBind: 'Log In and Bind',
      profileDetailsDescription: 'Review the display name, avatar, and email imported from {providerName}.',
      profileDetailsTitle: 'Review {providerName} Profile',
      reviewProfileBeforeContinue: 'Review the imported profile before continuing.',
      signInThenBindDescription: 'Sign in to an existing account first, then bind it to your {providerName} identity.',
      suggestedEmail: 'Suggested email: {email}',
      totpHint: 'Enter the 2FA code for {account} to continue.',
      useAvatar: 'Use Avatar',
      useDifferentEmail: 'Use Different Email',
      useDisplayName: 'Use Display Name',
      verifyAndContinue: 'Verify and Continue',
      wechatAvailabilityUnknown: 'Unable to determine whether the current environment supports WeChat login.',
      wechatBrowserOnly: 'Open this page in the WeChat in-app browser to continue.',
      wechatNotConfigured: 'WeChat login is not configured.',
      wechatSystemBrowserOnly: 'Open this page in a system browser. The WeChat in-app browser does not support this flow.',
    ...
    wechatPayment: {
      ...
      callbackMissingResumeToken: 'WeChat payment callback is missing the resume token.',
      callbackProcessing: 'Restoring WeChat payment...',
      callbackTitle: 'Restoring WeChat Payment'
    },
    // Forgot password
  ...
  admin: {
    ...
    channels: {
      ...
      emptyModelsInPricing: 'There is a pricing entry under {platform} with no models selected. Add models or remove that entry.',
    ...
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Configure alert thresholds for metrics. Values beyond thresholds will be highlighted in red.',
        slaMinPercent: 'SLA Minimum Percentage',
        slaMinPercentHint: 'Display SLA in red when it falls below this value (default: 99.5%).',
        ttftP99MaxMs: 'TTFT P99 Maximum (ms)',
        ttftP99MaxMsHint: 'Display TTFT P99 in red when it exceeds this value (default: 500ms).',
        requestErrorRateMaxPercent: 'Request Error Rate Maximum (%)',
        requestErrorRateMaxPercentHint: 'Display request error rate in red when it exceeds this value (default: 5%).',
        upstreamErrorRateMaxPercent: 'Upstream Error Rate Maximum (%)',
        upstreamErrorRateMaxPercentHint: 'Display upstream error rate in red when it exceeds this value (default: 5%).',
        validation: {
          title: 'Please fix the following issues',
