export default {
    settings: {
      ...
      payment: {
        ...
        field_infiniCurrencyHint: 'Infini only accepts USD. Packages stay RMB-priced; checkout converts with the USDT balance FX rate. A CNY instance currency is forced to USD so Infini never receives a CNY order.',
