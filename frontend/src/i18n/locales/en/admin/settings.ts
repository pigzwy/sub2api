export default {
    settings: {
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar navigation. Each page can be visible to regular users or administrators, and can either embed in this site or navigate away.',
        ...
        openMode: 'Open In',
        openModeIframe: 'Iframe (embedded in this site)',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many USD balance the user receives for each 1 unit paid. This conversion always applies; package bonuses are extra USD on top.',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} USD',
        rechargePackages: 'Recharge packages',
        rechargePackagesHint: 'Controls the user recharge cards. Credited USD = pay amount x recharge rate + that package USD bonus. A zero bonus still uses the rate.',
        rechargePackagesCount: '{count} packages',
        expandPackages: 'Expand',
        collapsePackages: 'Collapse',
        addPackage: 'Add package',
        removePackage: 'Remove',
        resetPackages: 'Reset defaults',
        packageName: 'Name',
        packageNameEn: 'English name',
        packageDesc: 'Description',
        packageDescEn: 'English description',
        packageAmount: 'Pay amount',
        packageBonus: 'Bonus USD',
        packageBadge: 'Badge',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe, Airwallex, and Infini can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, and EasyPay remain CNY. Infini hosted checkout uses this fiat amount; users then pay USDT on Infini\'s page.',
        field_infiniApiBaseHint: 'Must match the Infini key environment: use https://openapi-sandbox.infini.money for sandbox keys, and https://openapi.infini.money for production keys.',
        field_payMethods: 'Pay methods',
        field_infiniPayMethodsHint: 'Optional Infini pay_methods list. Default 1 is crypto/USDT only. Use 1,2,3,5,6 to also allow card, Binance Pay, Apple Pay, and Google Pay.',
        infiniWebhookHint: 'Configure the following URL as a Webhook endpoint in the Infini merchant backend. Subscribe to order.update so you receive order.completed and order.expired.',
        infiniGuideSummary: 'Infini hosted checkout only needs create-order, redirect to checkout_url, and webhook verification.',
        infiniGuideNote: 'Create an HMAC key on the Infini developer page, copy the webhook secret shown there, and keep refunds disabled unless Infini later exposes a merchant refund API.',
