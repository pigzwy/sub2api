export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many USD balance the user receives for each 1 CNY paid. Used when no package bonus is configured.',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} USD',
        rechargePackages: 'Recharge packages',
        rechargePackagesHint: 'Controls the user recharge cards. After any package has a bonus, matching amounts credit pay + bonus and ignore the global multiplier.',
