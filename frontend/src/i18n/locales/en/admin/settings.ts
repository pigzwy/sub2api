export default {
    settings: {
      ...
      payment: {
        ...
        field_infiniCurrencyHint: 'Infini only accepts USD and never settles as USDT. Packages stay RMB-priced; checkout converts with the USDT balance FX rate. Leftover CNY/USDT/empty instance currencies are forced to USD so quote and CreateOrder stay consistent.',
