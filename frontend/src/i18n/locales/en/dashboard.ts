export default {
  ...
  usage: {
    ...
    tabs: { usage: 'Usage', errors: 'Error Requests', audit: 'Request Audit', ranking: 'User Ranking' },
    errors: {
  ...
  checkin: {
    ...
    readyHint: 'You have not checked in today — claim your reward.',
    signedHint: 'Already checked in today. Come back tomorrow.',
