export default {
  ...
  payment: {
    ...
    tabPayAsYouGo: 'Pay as you go',
    tabMonthlyPlan: 'Monthly plan',
    rechargeNow: 'Recharge now',
    selectPaymentMethod: 'Select payment method',
    paymentInfo: 'Payment information',
    fxRateLabel: 'Rate: 1 USD = {rate} CNY',
    quoteLoading: 'Calculating payment amount',
    quoteFailed: 'Unable to calculate the payment amount. Please try again.',
    rmbPay: 'RMB',
    usdtPay: 'USDT',
    ...
    noUsdtMethods: 'No USDT payment method is available',
    packages: {
      starter: { name: 'Starter', desc: 'For a first try' },
      standard: { name: 'Standard', desc: 'Popular with developers' },
      advanced: { name: 'Advanced', desc: 'For growing usage' },
      pro: { name: 'Pro', desc: 'For professional teams' },
      team: { name: 'Team', desc: 'For small teams' },
      business: { name: 'Business', desc: 'For business workloads' },
      premium: { name: 'Premium', desc: 'For heavy usage' },
      enterprise: { name: 'Enterprise', desc: 'For enterprise volume' },
    },
