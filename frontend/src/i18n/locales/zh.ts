export default {
  ...
  auth: {
    ...
    oauthFlow: {
      ...
      bindCurrentAccountDescription: '将当前已登录账号与 {providerName} 身份绑定。',
      bindCurrentAccountTitle: '绑定到当前已登录账号',
      bindExistingAccount: '绑定已有账号',
      bindLoginHint: '登录现有账号后，将其与 {providerName} 身份绑定。',
      bindSignInToExistingAccount: '登录并绑定到现有账号',
      chooseAccountActionHint: '你可以绑定已有账号，或直接创建新账号。',
      chooseHowToContinue: '选择继续方式',
      createAccountHint: '将使用当前资料创建一个新的本地账号。',
      createNewAccount: '创建新账号',
      logInAndBind: '登录并绑定',
      profileDetailsDescription: '确认从 {providerName} 同步的昵称、头像和邮箱信息。',
      profileDetailsTitle: '完善 {providerName} 资料',
      reviewProfileBeforeContinue: '继续前请检查从 {providerName} 获取的资料。',
      signInThenBindDescription: '登录一个现有账号，然后与 {providerName} 身份绑定。',
      suggestedEmail: '建议邮箱：{email}',
      totpHint: '请输入 {account} 的两步验证码以继续。',
      useAvatar: '使用头像',
      useDifferentEmail: '使用其他邮箱',
      useDisplayName: '使用昵称',
      verifyAndContinue: '验证并继续',
      wechatAvailabilityUnknown: '暂时无法确认当前环境是否支持微信登录。',
      wechatBrowserOnly: '请在微信内置浏览器中打开此页面继续。',
      wechatNotConfigured: '微信登录暂未配置。',
      wechatSystemBrowserOnly: '请使用系统浏览器打开此页面，微信内置浏览器暂不支持此流程。',
      yourAccount: '当前账号'
    },
    sendCode: '发送验证码',
  ...
  profile: {
    ...
    authBindings: {
      ...
      notes: {
        emailManagedFromProfile: '主邮箱请在个人资料表单中管理',
        canUnbind: '你可以解绑这个登录方式',
        bindAnotherBeforeUnbind: '请先绑定其他登录方式，再解绑当前方式',
      },
    }
  },
  ...
  admin: {
    ...
    channels: {
      ...
      noGroupsSelected: '平台 {platform} 未选择分组，请至少选择一个分组或禁用该平台',
      emptyModelsInPricing: '平台 {platform} 下有定价条目未添加模型，请添加模型或删除该条目',
      createError: '创建渠道失败',
      updateError: '更新渠道失败',
      deleteError: '删除渠道失败',
    ...
    accounts: {
      ...
      imagePromptPlaceholder: '例如：生成一只戴宇航员头盔的橘猫贴纸，像素插画风格，纯色背景。',
      imagePromptDefault: '生成一张可爱的橘猫宇航员贴纸，浅色粉彩背景，画面干净简洁。',
