export default {
  ...
  payment: {
    ...
    paymentInfo: '支付信息',
    fxRateLabel: '汇率：1 USD = {rate} CNY',
    quoteLoading: '正在计算支付金额',
    quoteFailed: '无法获取支付金额，请稍后重试',
    rmbPay: 'RMB支付',
    usdtPay: 'USDT支付',
    supportedMethods: '支持',
    neverExpires: '永不过期',
    ...
    popular: '人气推荐',
    bestValue: '最佳价值',
    noUsdtMethods: '暂无可用的 USDT 支付方式',
    packages: {
      starter: { name: '体验', desc: '适合初次体验' },
      standard: { name: '标准', desc: '开发者常用' },
      advanced: { name: '进阶', desc: '进阶用户首选' },
      pro: { name: '专业', desc: '专业团队推荐' },
      team: { name: '团队', desc: '小团队协作' },
      business: { name: '商务', desc: '商务规模使用' },
      premium: { name: '尊享', desc: '高频重度使用' },
      enterprise: { name: '企业', desc: '企业级用量' },
    },
    noPlans: '暂无可用订阅套餐',
